            ...
            >
                ...
                >
                    ...
                    <View style={styles.section}>
                        <View style={styles.sectionHeader}>
                            ...
                            {(selection.behandlung || selection.produkt || selection.typ || selection.laenge) && (
                    ...
                    {selectedProduct && (
                        <View style={styles.productInfoCard}>
                            <View style={styles.productInfoRow}>
                                <Text style={styles.productInfoLabel}>Einkaufspreis (Brutto) pro Stück</Text>
                            ...
                            {selectedProduct.artikelId && (
                                <View style={styles.productInfoRow}>
                                    ...
                                    <Text style={styles.productInfoValueSmall}>{selectedProduct.artikelId}</Text>
                                </View>
                            )}
                            {selectedProduct.info && (
                                <View style={styles.productInfoRow}>
                                    <Text style={styles.productInfoLabel}>Info</Text>
                                    <Text style={styles.productInfoValueSmall}>{selectedProduct.info}</Text>
                                </View>
                            )}
                        </View>
                    )}
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.calculationCard}>
                            ...
                            <View style={styles.calcRow}>
                                ...
                                <Text style={styles.calcValue}>{formatCurrency(stundenlohn)}</Text>
                            </View>

                            <View style={styles.calcRow}>
                                <Text style={styles.calcLabel}>Schnittpreis</Text>
                                <Text style={styles.calcValue}>{formatCurrency(schnittpreis)}</Text>
                            </View>
                ...
                <View style={styles.summaryContainer}>
                    ...
                    <View style={styles.totalRow}>
                        ...
                        <Text style={styles.totalValue}>{formatCurrency(calculations.gesamtpreis)}</Text>
                    </View>
                </View>
            </KeyboardAvoidingView>
        </SafeAreaView>
